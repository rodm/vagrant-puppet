#
# Puppet master and node VMs configured using shell scripts
#
...
nodes = [
  { :hostname => 'puppet', :ip => '192.168.80.10', :ram => '512' },
  { :hostname => 'node1',  :ip => '192.168.80.11', :ram => '512' },
  { :hostname => 'node2',  :ip => '192.168.80.12', :ram => '512', :box => precise64_box, :url => precise64_url },
  { :hostname => 'node3',  :ip => '192.168.80.13', :ram => '512', :box => centos64_box, :url => centos64_url }
]
